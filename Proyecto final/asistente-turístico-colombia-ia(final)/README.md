...
- **Integración con Gemini:** Utiliza el modelo `gemini-1.5-flash` para generar respuestas de chat inteligentes y contextuales.
...
- **Enriquecimiento de Datos:** Busca y añade URLs de imágenes para los lugares turísticos identificados utilizando la API de Wikimedia.
